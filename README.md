...
- Los selectores usan atributos robustos (`data-test`) para mayor estabilidad.
...
- Si ejecuta en Windows, utilice la terminal de VS Code y ejecute `chcp 65001` antes de correr los tests para asegurar la correcta visualización de caracteres.
